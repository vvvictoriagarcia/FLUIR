    ...
    <div className="min-h-screen pb-44 md:pl-60">
      <div className="mx-auto max-w-xl px-5 py-6 lg:max-w-6xl lg:px-8 xl:max-w-[1400px]">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
          {loading ? (
            <div className="h-24 animate-pulse rounded-card bg-muted sm:col-span-2 xl:col-span-3" />
          ) : items.length === 0 ? (
            <div className="rounded-card border border-dashed border-border p-8 text-center sm:col-span-2 xl:col-span-3">
